    ...
    updateQuizData.contentSetting = updateQuizData.contentSetting.map(
      (content, index2) => {
        if (index === index2) {
          ...
          // Check if dropdown is an array before mapping
          content = {
            ...content,
            questionSetting: {
              ...questionSetting,
              dropdown: questionSetting.dropdown.map(
                (item, multiindex) => {
    ...
    <div>
      <div>
        ...
        <div className="flex flex-col gap-3 place-items-start">
          {quizData.contentSetting[index].questionSetting.dropdown.map(
